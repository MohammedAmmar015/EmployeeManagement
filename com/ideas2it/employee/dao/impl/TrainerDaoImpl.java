...
public class TrainerDaoImpl implements TrainerDao {
    ...
    *		 it returns number of row inserted
    **/
    ...
    **/
    ...
    /**
    * <p>
    * This method is used to Retrive the particular Trainer details from database using Hibernate
    * Based on Trainer Id
    * </p>
    * @param - trainerId
    ...
    **/
    public Trainer retriveTrainerById(int trainerId) {
